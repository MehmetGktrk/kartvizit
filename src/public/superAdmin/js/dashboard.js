...
function updateDashboard(data) {
    ...
    document.getElementById("totalAdmin").innerHTML = data.totalAdmin;
    document.getElementById("totalCompany").innerHTML = data.totalCompany;
    document.getElementById("totalActiveUser").innerHTML = data.totalActiveUser
    document.getElementById("totalInactiveUser").innerHTML = data.totalInactiveUser
